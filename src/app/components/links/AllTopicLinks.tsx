    ...
    >
      Cancel
                ...
                <li className="mb-3 mt-3 flex justify-between items-start md:items-center">
                  ...
                  <img src={`https://api.screenshotone.com/take?access_key=Id53MuBcmnqVNA&url=${link.url}`} alt={`Screenshot of ${link.title}`} className="w-20 h-20 object-cover md:mr-12 md:mb-0 md:w-52 md:h-24" />
