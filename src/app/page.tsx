      ...
      <div className="mt-8 w-full flex flex-col items-center justify-center text-center">
        ...
        <main className="flex flex-1 flex-col items-center justify-center w-full px-20 text-black">
          ...
          <p className="mt-3 text-2xl">
            Your personal space for <span className="text-purple-600">learning management</span>.
          </p>
          ...
          <div className="mt-8 max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white shadow-md rounded-lg p-6">
                ...
                <p>Organize your notes, files, and links into topics for easy access.</p>
                <img src="https://via.placeholder.com/150" alt="Create Topics" className="mt-2"/>
              </div>
              <div className="bg-white shadow-md rounded-lg p-6">
                <h2 className="font-semibold text-lg">Add Resources</h2>
                <p>Effortlessly add notes, files, images, and links to your topics.</p>
                <img src="https://via.placeholder.com/150" alt="Add Resources" className="mt-2"/>
              </div>
            </div>
          </div>
        </main>
